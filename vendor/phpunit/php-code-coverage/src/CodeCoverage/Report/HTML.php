...
class PHP_CodeCoverage_Report_HTML
{
    ...
    {
        $dir = $this->getDirectory($target . 'vendor');
        copy($this->templatePath . 'vendor/bootstrap.min.vendor', $dir . 'bootstrap.min.vendor');
        copy($this->templatePath . 'vendor/nv.d3.min.vendor', $dir . 'nv.d3.min.vendor');
        copy($this->templatePath . 'vendor/style.vendor', $dir . 'style.vendor');
